...
console.log(res.data);`
  ...
  oqs: {
    lang: "OQS Query",
    command: "onyxdb start",
    code: `// Onyx Query Syntax (OQS) Payload
{
  ...
  java: {
    lang: "Java Maven",
    command: "java -jar onyxdb-api-0.2.0.jar",
    ...
    <section className="w-full flex flex-col items-center justify-center py-6 z-10 my-auto">
      <div className="mx-auto w-full max-w-[980px] text-center flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <Play className="w-4 h-4 fill-black" /> Explore Onyx Studio
          </button>
        ...
        >
          ...
          <div className="bg-black/80 px-4 py-3 border-b border-white/15 flex items-center justify-between flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-mono text-emerald-400 font-bold border border-emerald-500/30 bg-emerald-500/15 px-2.5 py-0.5 rounded-full">
          ...
          {/* Code Console Body */}
          <div className="p-4 font-mono text-xs sm:text-sm text-emerald-400 font-bold leading-relaxed overflow-x-auto bg-black/90">
