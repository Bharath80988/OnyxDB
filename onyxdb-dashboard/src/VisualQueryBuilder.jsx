  ...
  <div className={nodeStyle}>
    ...
    <div className="text-xs text-white/50">
      ...
      <input
        type="text"
        defaultValue="users"
        className="w-full bg-white/5 border border-white/10 rounded px-2 py-1 text-emerald-400 focus:outline-none focus:border-white/30"
      />
    </div>
...
const OqsNode = () => (
  <div className={nodeStyle}>
    ...
    <div className={headerStyle}>
      ...
      <span className="font-semibold text-sm text-white">OQS Query</span>
    </div>
    <div className="text-xs text-white/50 space-y-2">
      <div>
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-56 bg-black/80 backdrop-blur-xl border-l border-white/10 p-4 flex flex-col gap-4 z-10">
      ...
      <div
        className="bg-white/5 p-3 rounded-xl border border-white/10 flex items-center gap-3 cursor-grab hover:border-emerald-500/30 transition-colors"
      ...
      >
        <Database className="w-4 h-4 text-cyan-400" />
        <span className="text-sm font-medium">OQS Query</span>
      </div>
    </aside>
  );
};
