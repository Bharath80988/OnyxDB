      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        ...
        >
          ...
          <div className="text-center mb-8 relative z-10">
            ...
            <h2 className="text-2xl font-bold tracking-tight">Onyx Studio Login</h2>
            <p className="text-xs text-white/50 mt-1">Sign in to access your local OnyxDB instance</p>
          </div>
          ...
          <div className="pt-6 mt-6 border-t border-white/10">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <Key className="w-3 h-3 mr-1.5 text-emerald-400" />
                Admin
              </button>
              <button
                type="button"
