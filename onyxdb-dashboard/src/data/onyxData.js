export const onyxSubsystems = [
  ...
  },
  {
    ...
    subhead: "High-throughput Multi-Reactor TCP server on port 8081 featuring Onyx Wire Protocol (OWP) 9-byte binary header framing.",
    indicators: [
      "● OWP BINARY HEADER",
      "● PORT 8081 NIO",
  ...
  {
    id: "optimizer",
    label: "04 / OQS & EXPLAIN",
    shortName: "Query Optimizer",
    headline: "Cost-Based Query\nOptimizer Engine",
    subhead: "Declarative Onyx Query Syntax (OQS) with Cost-Based Optimizer (CBO) EXPLAIN execution profiler for I/O cost estimation.",
    indicators: [
      "● OQS SYNTAX PARSER",
  ...
  },
  {
    ...
    subhead: "Zero-dependency distribution across PyPI (pip install onyxdb), NPM (npx onyxdb), Java Maven, and embedded standalone Uber-JAR.",
    indicators: [
      "● PIP INSTALL ONYXDB",
      "● NPX ONYXDB",
      "● JAVA MAVEN STARTER",
