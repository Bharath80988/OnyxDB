...
export const CodeBlock = ({ file, code }) => (
  <div className="bg-[#0d0d0d] border border-white/10 rounded-xl overflow-hidden my-6">
    ...
    <pre className="p-4 text-xs font-mono text-emerald-400 overflow-auto whitespace-pre-wrap break-words">
      {code}
    </pre>
  </div>
);
...
export const frameworks = [
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Configure the OnyxDB connection URL in your properties or YAML file.</p>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Create a REST Controller that connects to OnyxDB and returns a Hello World record.</p>
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Configure your OnyxDB URL inside the Django settings file.</p>
...
ONYXDB_URL = 'http://localhost:8080'`} />
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Create a view that queries OnyxDB, and wire it up in your URLs.</p>
    ...
    chapters: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Flask is incredibly lightweight. A single file is all you need to interact with OnyxDB.</p>
    ...
    chapters: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">FastAPI allows for lightning-fast asynchronous requests. We use httpx for non-blocking IO to OnyxDB.</p>
    ...
    chapters: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">PHP can natively connect to OnyxDB without any heavy dependencies.</p>
    ...
    chapters: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Go is perfect for OnyxDB. Fast, compiled, and highly concurrent.</p>
    ...
    chapters: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-white/60 leading-relaxed">Rust provides memory safety and incredible speed, pairing perfectly with OnyxDB.</p>
