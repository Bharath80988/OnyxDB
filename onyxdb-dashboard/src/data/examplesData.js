export const queryExamples = [
  {
    ...
    explanation: "OnyxDB's HNSW vector index intercepts relational metadata filters during graph traversal. It evaluates Cosine distance on candidate nodes matching B+ Tree index slots, avoiding full table post-filtering.",
    payload: {
    ...
    oqsEquivalent: "VECTOR_SEARCH products TOP 5 [0.12, 0.85, 0.43, -0.21] WHERE category = 'hardware'",
    nodes: [
      ...
      { id: '3', type: 'oqsNode', position: { x: 660, y: 150 }, data: { query: 'VECTOR_SEARCH k=5' } }
    ]
  },
  {
    id: "q2",
    ...
    oqsEquivalent: "DELETE users 101 CASCADE",
    nodes: [
  ...
  },
  {
    ...
    payload: {
      oqs: "EXPLAIN FIND orders WHERE status = 'COMPLETED' AND amount > 500"
    },
    oqsEquivalent: "EXPLAIN FIND orders WHERE status = 'COMPLETED' AND amount > 500",
    nodes: [
      { id: '1', type: 'oqsNode', position: { x: 200, y: 150 }, data: { query: 'EXPLAIN FIND orders...' } }
    ]
  },
  {
    id: "q4",
    ...
    oqsEquivalent: "ADD CONSTRAINT fk_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE RESTRICT",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "INSERT INTO inventory {\"id\": 5001, \"sku\": \"GPU-H100-80G\", \"quantity\": 64}",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "INDEX users ON email",
    nodes: [
  ...
  },
  {
    ...
    explanation: "QueryEngine routes 'email = alice@onyx.db' directly to users_email.idx B+ Tree, retrieving primary key pointers in log time.",
    payload: {
      action: "select",
      table: "users",
      where: {
    ...
    oqsEquivalent: "FIND users WHERE email = 'alice@onyx.db'",
    nodes: [
      { id: '1', type: 'selectNode', position: { x: 100, y: 150 }, data: { table: 'users' } },
      { id: '2', type: 'filterNode', position: { x: 380, y: 150 }, data: { field: 'email = alice@onyx.db' } }
    ]
  },
  {
    id: "q8",
    title: "8. Onyx Wire Protocol (OWP) Binary Framing Query",
    category: "Networking",
    difficulty: "Hard",
    ...
    payload: {
      ...
      payload_len: 42,
      oqs: "GET telemetry_events 9901"
    },
    oqsEquivalent: "OWP_SOCKET_QUERY [0x4F4E5958][0x01][LEN] GET telemetry_events 9901",
    nodes: [
      { id: '1', type: 'oqsNode', position: { x: 200, y: 150 }, data: { query: 'OWP TCP 8081 Query' } }
    ]
  },
  {
    id: "q9",
    ...
    oqsEquivalent: "UPDATE wal_test 701 SET tx_status = 'COMMITTED'",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "UPDATE orders 5001 SET status = 'SHIPPED'",
    nodes: [
  ...
  },
  {
    ...
    category: "AI & Vector Search",
    difficulty: "Hard",
    description: "Store a 1536-dimensional OpenAI text embedding alongside JSON document attributes in OnyxDB.",
    ...
    oqsEquivalent: "INSERT INTO ai_documents {\"id\": 9901, \"title\": \"Transformer...\", \"vector\": [...]}",
    nodes: [
      { id: '1', type: 'selectNode', position: { x: 100, y: 150 }, data: { table: 'ai_documents' } },
      { id: '2', type: 'oqsNode', position: { x: 400, y: 150 }, data: { query: 'INSERT 1536-dim VECTOR' } }
    ]
  },
  {
    id: "q12",
    ...
    oqsEquivalent: "FIND audit_logs WHERE severity = 'CRITICAL' AND resolved = false",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "DELETE session_tokens 8841 WITH AUTH_BEARER",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "MSYNC telemetry_events ASYNC",
    nodes: [
  ...
  },
  {
    ...
    oqsEquivalent: "SHOW METRICS",
    nodes: [
      { id: '1', type: 'oqsNode', position: { x: 200, y: 150 }, data: { query: 'SHOW METRICS' } }
    ]
  }
];
