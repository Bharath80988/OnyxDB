...
/**
 * Forge Interactive Terminal CLI — a SQL-like REPL shell for ForgeQL.
 *
 * <p>Features:
 * <ul>
 ...
 * </p>
 *
 * <p>Usage: {@code java -cp forgeql-api-*.jar com.forgeql.api.cli.ForgeCli [data-dir]}</p>
 */
public class ForgeCli {
    ...
    // ─── Known FQL / meta-command keywords for auto-completion ───────────────────
    ...
    public static void main(String[] args) {
        String dataDir = args.length > 0 ? args[0] : System.getProperty("user.home") + "/ForgeQL/database";

        // ─── Startup banner ───────────────────────────────────────────────────────
        System.out.println(BOLD + CYAN +
            "╔══════════════════════════════════════════════════╗\n" +
            "║       ForgeQL Interactive Terminal  v4.0.0        ║\n" +
        ...
        try {
            ...
            while (true) {
                ...
                String prompt = multiLineBuffer.length() > 0
                    ...
                    : BOLD + CYAN + "forge> " + RESET;  // Primary prompt
            ...
            System.err.println(RED + "Failed to start Forge CLI: " + e.getMessage() + RESET);
        }
    }
    ...
    /**
     * Returns true if the statement is a known single-line FQL command that does not need ';'.
    ...
    private static void printHelp() {
        System.out.println(BOLD + "\n  Forge Query Syntax (FQL) Reference:" + RESET);
        ...
        printHelpRow("EXIT / quit",         "Exit the Forge REPL shell");
