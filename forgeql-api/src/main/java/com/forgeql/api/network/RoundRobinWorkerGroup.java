...
public class RoundRobinWorkerGroup {
    ...
    public RoundRobinWorkerGroup(int poolSize, ExecutionEngine executionEngine) throws IOException {
        ...
        for (int i = 0; i < poolSize; i++) {
            workers[i] = new WorkerThread("Forge-NIO-Worker-" + i);
            workers[i].start();
        }
    ...
    private class WorkerThread extends Thread {
        ...
        private void readQuery(SelectionKey key) {
            ...
            try {
                ...
                // Attempt to decode Forge Wire Protocol (OWP) binary frame
                com.forgeql.core.execution.ForgeWireProtocol.Frame owpFrame = com.forgeql.core.execution.ForgeWireProtocol.decode(buffer);
                if (owpFrame != null) {
                    ...
                    ByteBuffer writeBuf = com.forgeql.core.execution.ForgeWireProtocol.encode(com.forgeql.core.execution.ForgeWireProtocol.MSG_RESPONSE, responsePayload);
