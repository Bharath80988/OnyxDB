...
import com.forgeql.api.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> login(@RequestBody Map<String, String> credentials) {
        ...
        String expectedAdminPass = (adminPassword != null && !adminPassword.isBlank()) ? adminPassword : System.getProperty("FORGE_ADMIN_PASS", "admin_demo_pass");
        String expectedReadOnlyPass = (readOnlyPassword != null && !readOnlyPassword.isBlank()) ? readOnlyPassword : System.getProperty("FORGE_READONLY_PASS", "read_demo_pass");
