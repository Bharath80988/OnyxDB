...
/**
 * REST API controller for executing ForgeQL queries and fetching server metrics.
 *
 * <p>Endpoints:
 * <ul>
 *   <li>{@code POST /api/query} — Execute a JSON or FQL query (requires Authorization header).</li>
...
public class QueryController {
     ...
     * Delegates to {@link com.forgeql.core.execution.ExecutionEngine#getSystemMetrics()}.
     */
    @GetMapping("/metrics")
