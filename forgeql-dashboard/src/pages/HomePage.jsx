...
import { forgeSubsystems, defaultHeroData } from '../data/forgeData';
...
const ARCH_FLOW_STEPS = [
  {
    ...
    desc: "Clients connect via HTTP REST (port 8080) or zero-copy 9-byte binary Forge Wire Protocol (OWP) over TCP (port 8081).",
    icon: Server,
...
export default function HomePage() {
  ...
  const currentSubsystem = forgeSubsystems[activeSubsystemIdx] || forgeSubsystems[0];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold tracking-tight mb-4">
              How ForgeQL Executes <span className="text-white/60">Queries</span>
            </h2>
            <p className="text-base text-white/60 leading-relaxed">
              An authentic look into ForgeQL's zero-copy memory pipeline from client socket initialization to on-disk B+ Tree commits.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-950/40 via-[#121214] to-black border border-white/10 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
            <div>
