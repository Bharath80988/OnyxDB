  ...
  core: [
    {
      ...
      desc: "Translates JSON nodes and FQL query strings into database operations across multi-table storage files.",
      ...
      file: "com.forgeql.core.execution.ExecutionEngine",
      specs: [
        { label: "Role", value: "Query Execution & Route Coordinator" },
        { label: "Query Parsers", value: "JSON AST & Forge Query Syntax (FQL)" },
...
public List<String> executeQuery(Map<String, Object> query) {
    ...
    },
    {
      ...
      file: "com.forgeql.core.storage.MmapStorageManager",
      specs: [
...
mmap.get(slotData);`
    },
    {
      ...
      file: "com.forgeql.core.index.BTreeManager",
      specs: [
...
if (slot >= 0) {
    ...
    },
    {
      ...
      file: "com.forgeql.core.index.hnsw.HnswIndex",
      specs: [
...
return formatVectorResults(neighbors);`
    },
    {
      ...
      file: "com.forgeql.core.schema.SchemaManager",
      specs: [
...
if ("RESTRICT".equals(policy) && hasChildRecords(childTable, parentId)) {
    ...
    },
    {
      ...
      file: "com.forgeql.core.wal.WriteAheadLog",
      specs: [
...
walChannel.force(false); // msync flush`
  ...
  api: [
    {
      id: "socket_server",
      title: "ForgeNativeSocketServer.java",
      tag: "TCP NIO SERVER",
      ...
      file: "com.forgeql.api.network.ForgeNativeSocketServer",
      specs: [
...
// Non-blocking NIO acceptor loop`
    },
    {
      ...
      file: "com.forgeql.api.network.RoundRobinWorkerGroup",
      specs: [
        ...
        { label: "Protocol Unpacker", value: "ForgeWireProtocol Decoder" }
      ],
...
worker.registerChannel(socketChannel);`
    },
    {
      ...
      file: "com.forgeql.api.QueryController",
      specs: [
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 text-orange-400 text-xs font-mono mb-4 border border-white/10">
            <Layers className="w-3.5 h-3.5" /> ForgeQL System Architecture
          </div>
          ...
          {components.map((c, idx) => (
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-xl font-mono font-bold mb-2 group-hover:text-orange-400 transition-colors">
                  {c.title}
                </h3>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-mono">
                ...
                <span className="text-orange-400 font-bold group-hover:underline">Inspect Class &rarr;</span>
              </div>
            </motion.div>
          ))}
        </div>
