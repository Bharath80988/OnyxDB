...
const SAMPLE_QUERIES = [
  ...
  { label: 'EXPLAIN Profiler', payload: '{\n  "fql": "EXPLAIN FIND users WHERE status = ACTIVE"\n}' },
];
...
export default function StudioModal({ isOpen, onClose }) {
  ...
  const handleRunQuery = async (queryPayload) => {
    setLoading(true);
    setResult('Executing query against ForgeQL engine...');
    try {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-base tracking-tight flex items-center gap-2">
                    Forge Studio <span className="text-xs px-2 py-0.5 rounded-full bg-orange-500/20 text-orange-400 font-mono">v4.0.0 LIVE</span>
                  </h2>
                ...
                <div className="mt-auto">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3 space-y-2 text-xs">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-orange-400 font-mono">ONLINE (Port 8080)</span>
                    </div>
                    <div className="flex justify-between items-center">
                ...
                {view === 'json' ? (
                  <div className="p-6 flex-1 flex flex-col gap-4 overflow-auto">
                    ...
                    <textarea
                      ...
                      className="w-full h-48 bg-black/60 border border-white/10 rounded-xl p-4 font-mono text-xs text-orange-400 focus:outline-none focus:border-white/30 resize-none"
                      spellCheck={false}
                    />
