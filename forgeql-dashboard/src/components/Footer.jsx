    ...
    <footer className="border-t border-white/10 bg-black text-white pt-16 pb-12 font-sans shrink-0 relative z-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-4 group">
              <Logo size={24} />
              <span className="text-sm font-bold tracking-tight text-white group-hover:text-white/90">ForgeQL</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-white/60">
              <li><Link to="/studio" className="hover:text-white transition-colors">Forge Studio IDE</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-white/60 font-mono">
              <li><a href="https://pypi.org/project/forgeql/" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">pip install forgeql</a></li>
              <li><a href="https://www.npmjs.com/package/forgeql" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">npx forgeql</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Maven forgeql-core</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/40">
          <div>&copy; 2026 ForgeQL, Inc. All rights reserved.</div>
